...
class Auth_model extends CI_Model
{
     ...
     public function perfil_usuario($id)
    {
        ...
        //$q = $this->db->get('perfil_usuario');
        $q = $this->db->get_where('perfil_usuario', array('user_id' => $id));
       
        return $q;
    }
    
     public function setor_usuario($id)
    {
    
        //$q = $this->db->get('perfil_usuario');
        $q = $this->db->get_where('users_setores', array('usuario' => $id));
    ...
    public function updateAvatarEmpresa($id, $avatar)
    {
      
        if ($this->db->update('empresa', array('avatar' => $avatar), array('id' => $id))) {
            $this->set_message('avatar_updated');
            return TRUE;
        }
        return FALSE;
       ...
       public function updateEmpresa($id, $data)
    {
        ...
        if ($this->db->update('empresa', $data, array('id' => $id))) {
            $this->set_message('empresa_updated');
            return TRUE;
