                                             ...
                                             <?php
                                                ...
                                                foreach ($periodos as $periodo) {
                                                   ...
                                                   ?>   
                                                    ...
                                                    <tr   class="odd gradeX">
                                                        <td><?php echo $cont++; ?></td> 
                                                        <td><?php echo $periodo->nome.' '.$periodo->sobrenome; ?></td> 
                                                        ...
                                                        <td class="center">
                                                            <a target="_blank" style="background-color: chocolate; color: #ffffff;" class="btn fa fa-folder-open-o" href="<?= site_url('Projetos/detalhesPeriodoCompetencia/' . $periodo->id); ?>"> </a>
                                                        </td>
