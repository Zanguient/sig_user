                    ...
                    foreach ($lacamentos as $periodo) {
                       ...
                       ?>   
                        ...
                        <tr  >
                            ...
                            <td style="width: 40%;"><?php echo $periodo->descricao; ?> </td>
                            ...
                            <td style="width: 15%;"><?php if($periodo->id_acao != 0){ echo $periodo->id_acao; }else{ if($periodo->descricao){ echo 'N/A'; } } ?> </td>
                            ...
                            <td style="width: 10%;" class="center">
                                ...
                                <?php 
                                    ...
                                    ?>
                                        <a style="background-color: green; color: #ffffff;" class="btn fa fa-plus" href="<?= site_url('welcome/editarRequisicaoHorasDetalhes/'.$periodo->id); ?>" data-toggle="modal" data-target="#myModal">  </a>
