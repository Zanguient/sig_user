      ...
      <div class="row">
            ...
            <div class="box-body">
              ...
              <div class="attachment-block clearfix">
                  ...
                  <div class="pull-right">
                            <a target="_blank" class="btn btn-primary btn-sm btn-flat" href="<?php echo base_url().'assets/uploads/projetos/'.$post->anexo; ?>"><i class="fa fa-download"> VER </i></a>
        ...
        <section class="col-lg-3 " >
          ...
          //  foreach ($equipes as $equipe) {
            ...
            ?>
                        <li>
                            <img style="height: 60px;" src="<?= $avatar ? $assets . '../../../assets/uploads/avatars/thumbs/' . $avatar : $assets . 'images/' . $genero . '.png'; ?>" alt="User Image">
